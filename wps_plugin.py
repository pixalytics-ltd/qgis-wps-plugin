...
class WPSWidget:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Web Processing Service')

        #print "** INITIALIZING WPSWidget"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('WPSWidget', message)
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'Show WPS Widget'),
            callback=self.run,
    ...
    def unload(self):
        ...
        #print "** UNLOAD WPSWidget"

        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Web Processing Service'),
                action)
